...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget get textFormFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodySmallOrange400,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get fillOnPrimaryTL101 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.h),
        borderSide: BorderSide.none,
      );
  static OutlineInputBorder get fillOnPrimaryTL5 => OutlineInputBorder(
